...
public class DurationAdapter extends RecyclerView.Adapter<DurationAdapter.ViewHolder>{
    ...
    public DurationAdapter(Context context, ArrayList<SearchModel> searchModelArrayList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final DurationAdapter.ViewHolder holder, final int position) {
